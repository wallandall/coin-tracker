...
class CurrenciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create currency" do
    assert_difference('Currency.count') do
      post currencies_url, params: { currency: { amount_owned: @currency.amount_owned, cost_per: @currency.cost_per, symbol: @currency.symbol, user_id: @currency.user_id } }
    end
  ...
  test "should update currency" do
    patch currency_url(@currency), params: { currency: { amount_owned: @currency.amount_owned, cost_per: @currency.cost_per, symbol: @currency.symbol, user_id: @currency.user_id } }
